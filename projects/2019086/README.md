...
| 2 | βιογραφικό και δημιουργία ομάδας | [Link Βιογραφικού](https://chris-livas.github.io/online-cv/) [Link Ομάδας](https://github.com/OompaLoompas) [Link συζητήσεις](https://github.com/courses-ionio/help/discussions/244)| Για το 2ο παραδοτεο δημιούργησα το βιογραφικό μου και μπήκα σε ομάδα. |
