...
| 2 | βιογραφικό και δημιουργία ομάδας | [Link Βιογραφικού](https://github.com/Chris-Livas/online-cv) [Link Ομάδας](https://github.com/OompaLoompas) | Για το 2ο παραδοτεο δημιούργησα το βιογραφικό μου και μπήκα σε ομάδα. |
